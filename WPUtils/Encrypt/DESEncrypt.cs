...
namespace WPHubsUtil
{
    public class DESEncrypt
    {
        ...
        public static string Encrypt(string text, string skey, bool uppercase = false)
        {
            ...
            des.Key = Encoding.ASCII.GetBytes(MD5Encrypt.Encrypt(skey, uppercase).Substring(0, 8));
            des.IV = Encoding.ASCII.GetBytes(MD5Encrypt.Encrypt(skey, uppercase).Substring(0, 8));
